...
# Problem Solutions
seq_a <- seq(5, -11, by = -0.3)
seq_b <- rev(seq_a)
rep_vector <- rep(c(-1,3,-5,7,-9), each = 10, times = 2)
sorted_rep_vector <- sort(rep_vector, decreasing = TRUE)
vec_d <- c(6:12, rep(5.3, 3), -3, seq(102, length.out = 9))
vec_d_length <- length(vec_d)
